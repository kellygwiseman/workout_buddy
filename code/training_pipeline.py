...
if __name__ == '__main__':
	# process samples
	info = pd.read_csv('../data/training_info.csv', skipinitialspace=True)
	...
	c.support_vector_machine(sss, X, labels, stance=stance, C=10, gamma=1.0, prob=prob, pickle=pickle)
	ts = ts_arr[0]
